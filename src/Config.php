...
class Config
{
    ...
    * @example ['post_data'=>'UKZTHO::function']
    */
    public $post=[];
    /**
    * GET data process
    * get the get data and execute the function
    * @example ['get_data'=>'UKZTHO::function']
    */
    public $get=[];
    /**
    * add_filter data functions
    * @input array
    * @example ['body_class','UKZTHO::function',10,2]
    * @example ['body_class',['UKZTHO','function'],10,2]
    */
    public $add_filter=[];
    /**
    ...
    * @input array
    * @example [['example','UKZTHO\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['example','UKZTHO\ExampleController::example_shortcode']
    ];
    /**
    * Dashboard
